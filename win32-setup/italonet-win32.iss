...
#define MyAppName "Italonet"
#define MyAppVersion "0.7.0"
#define MyAppPublisher "Italo Project"
#define MyAppURL "https://italonet.org"
#define MyAppExeName "italonetui.exe"
...
OutputBaseFilename=italonet-win32
Compression=lzma2/ultra64
SolidCompression=yes
VersionInfoVersion=0.7.0
VersionInfoCompany=Italo Project
VersionInfoDescription=Italonet for Microsoft® Windows® NT™
#ifndef RELEASE
...
#endif
VersionInfoProductName=Italonet
VersionInfoProductVersion=0.7.0
InternalCompressLevel=ultra64
MinVersion=0,5.0
ArchitecturesInstallIn64BitMode=x64
VersionInfoCopyright=Copyright ©2018-2020 Italo Project
AppMutex=italonet_win32_daemon,italonet_qt5_ui,italonet_dotnet_ui
...
#ifdef SINGLE_ARCH
Source: "{#DevPath}build\italonet.exe"; DestDir: "{app}"; Flags: ignoreversion
; don't ship it, we don't have a public api yet!
;Source: "{#DevPath}build\libitalonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "dbghelp64.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}build\italonet.exe"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
;Source: "{#DevPath}build\libitalonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 32bit; Check: not IsWin64
Source: "dbghelp32.dll"; DestName: "dbghelp.dll"; DestDir: "{app}"; Flags: ignoreversion; Check: not IsWin64
Source: "{#DevPath}build64\italonet.exe"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
;Source: "{#DevPath}build64\libitalonet-shared.dll"; DestDir: "{app}"; Flags: ignoreversion 64bit; Check: IsWin64
Source: "dbghelp64.dll"; DestDir: "{app}"; DestName: "dbghelp.dll"; Flags: ignoreversion; Check: IsWin64
#endif
; UI has landed!
#ifndef RELEASE
Source: "{#DevPath}ui-win32\bin\debug\italonetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\italonetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\debug\italonetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#else
Source: "{#DevPath}ui-win32\bin\release\italonetui.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\italonetui.exe.config"; DestDir: "{app}"; Flags: ignoreversion
Source: "{#DevPath}ui-win32\bin\release\italonetui.pdb"; DestDir: "{app}"; Flags: ignoreversion
#endif
...
Source: "{#DevPath}build\italonetctl.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "LICENSE"; DestDir: "{app}"; Flags: ignoreversion
Source: "italonet-bootstrap.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "italonet-qt5-ui.7z"; DestDir: "{app}"; Flags: ignoreversion deleteafterinstall; MinVersion: 0,6.0;
Source: "italonet.ico"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "config_migration.bat"; DestDir: "{userappdata}\.italonet"; Flags: deleteafterinstall; MinVersion: 0,6.0
...
Type: filesandordirs; Name: "{app}\italonet-qt5-ui"; MinVersion: 0,6.0
Type: filesandordirs; Name: "{userappdata}\.italonet"
...
begin
  ...
  if IsTaskSelected('migrateconfigs') then
    MsgBox('Italonet JSON-RPC API endpoint enabled. Any custom configuration was retained in %APPDATA%\.italonet\italonet.old.ini.', mbInformation, MB_OK);
  end;
end;
...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; OnlyBelowVersion: 0, 6.0; IconFilename: "{app}\italonet.ico"
Name: "{group}\{#MyAppName}"; Filename: "{app}\italonet-qt5-ui\italonetui.exe"; MinVersion: 0, 6.0; IconFilename: "{app}\italonet.ico"
Name: "{group}\{cm:ProgramOnTheWeb,{#MyAppName}}"; Filename: "{#MyAppURL}"
Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; OnlyBelowVersion: 0,6.0; IconFilename: "{app}\italonet.ico"
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\italonet-qt5-ui\italonetui.exe"; Tasks: desktopicon; MinVersion: 0,6.0; IconFilename: "{app}\italonet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: quicklaunchicon; OnlyBelowVersion: 0, 6.1; IconFilename: "{app}\italonet.ico"
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\User Pinned\TaskBar\{#MyAppName}"; Filename: "{app}\italonet-qt5-ui\italonetui.exe"; Tasks: quicklaunchicon; MinVersion: 0, 6.1; IconFilename: "{app}\italonet.ico"
...
Filename: "{app}\italonet-qt5-ui\italonetui.exe"; Flags: nowait postinstall skipifsilent; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; MinVersion: 0,6.0
...
Filename: "{tmp}\7z.exe"; Parameters: "x italonet-qt5-ui.7z -aoa"; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated skipifdoesntexist; Description: "installing modern Qt5 UI"; StatusMsg: "Installing modern Qt5 UI..."; MinVersion: 0, 6.0;
Filename: "{app}\italonet-bootstrap.exe"; Parameters:"-L https://seed.italonet.org/italonet.signed --cacert rootcerts.pem -o ""{userappdata}\.italonet\bootstrap.signed"""; WorkingDir: "{app}"; Flags: runascurrentuser waituntilterminated; Description: "bootstrap dht"; StatusMsg: "Downloading initial RC..."
...
Filename: "{userappdata}\.italonet\config_migration.bat"; WorkingDir: "{userappdata}\.italonet"; Flags: runascurrentuser waituntilterminated; Description: "migrate existing config"; StatusMsg: "Migrating old configuration..."; MinVersion: 0,6.0; Tasks: migrateconfigs;